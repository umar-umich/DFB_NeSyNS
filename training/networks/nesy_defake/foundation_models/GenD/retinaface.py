...
def prepare_model(weights_path, det_thres=0.5, nms_thresh=0.4) -> RetinaFace:
    # model_file = "weights/det_10g.onnx"

    if not os.path.exists(weights_path):
        os.makedirs("weights", exist_ok=True)
        os.system(
            f"wget https://huggingface.co/datasets/theanhntp/Liblib/resolve/ae4357741af379482690fe3e0f2fa6fd32ba33b4/insightface/models/buffalo_l/det_10g.onnx -O {weights_path}"
        )
    ...
    model = RetinaFace(weights_path, providers=providers)
